...
from correlation_analysis import plot_correlation_with_mutation
...
# Step 3: Correlation Analysis between Mutation Count and Clinical Features
plot_correlation_with_mutation(df_cleaned, features=["Tumor Size", "Neoplasm Histologic Grade"])

# Step 4: Encode Features and Prepare for Modeling
